...
@Component({
  selector: 'app-post-jd-job-declined-candidate',
  templateUrl: './post-jd-job-declined-candidate.component.html',
  styleUrls: ['./post-jd-job-declined-candidate.component.css'],
})
export class PostJdJobDeclinedCandidateComponent implements OnInit {
