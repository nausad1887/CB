...
@Component({
  selector: 'app-shared-today-scheduled',
  templateUrl: './shared-today-scheduled.component.html',
  styleUrls: ['./shared-today-scheduled.component.css'],
})
export class SharedTodayScheduledComponent implements OnInit {
