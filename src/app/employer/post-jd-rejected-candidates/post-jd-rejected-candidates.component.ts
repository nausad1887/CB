...
@Component({
  selector: 'app-post-jd-rejected-candidates',
  templateUrl: './post-jd-rejected-candidates.component.html',
  styleUrls: ['./post-jd-rejected-candidates.component.css'],
})
export class PostJdRejectedCandidatesComponent implements OnInit {
