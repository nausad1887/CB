...
@Component({
  selector: 'app-post-jd-selected-onboarding',
  templateUrl: './post-jd-selected-onboarding.component.html',
  styleUrls: ['./post-jd-selected-onboarding.component.css'],
})
export class PostJdSelectedOnboardingComponent implements OnInit {
