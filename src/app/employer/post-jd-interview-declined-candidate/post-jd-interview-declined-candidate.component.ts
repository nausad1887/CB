...
@Component({
  selector: 'app-post-jd-interview-declined-candidate',
  templateUrl: './post-jd-interview-declined-candidate.component.html',
  styleUrls: ['./post-jd-interview-declined-candidate.component.css'],
})
export class PostJdInterviewDeclinedCandidateComponent implements OnInit {
